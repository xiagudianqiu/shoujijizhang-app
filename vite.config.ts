    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          ...
          icons: [
            {
              src: 'https://ui-avatars.com/api/?name=SL&background=0F172A&color=fff&size=192&font-size=0.5',
              sizes: '192x192',
              type: 'image/png'
            },
            {
              src: 'https://ui-avatars.com/api/?name=SL&background=0F172A&color=fff&size=512&font-size=0.5',
              sizes: '512x512',
              type: 'image/png'
            }
          ]
